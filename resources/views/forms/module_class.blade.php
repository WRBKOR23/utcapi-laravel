...
<x-header>
  ...
  <x-slot name="lib">
    ...
    <!-- Custom select2 -->
    <script src="{{ asset('js/forms/module-class/dist/js/select2.customSelectionAdapter.min.js') }}"></script>
    <!-- AlertifyJS -->
    ...
    <link rel="stylesheet" href="{{asset('css/forms/module-class/style.css')}}">
...
<script src="{{ asset('js/forms/module-class/script.js') }}" type="module"></script>
