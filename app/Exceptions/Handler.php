...
class Handler extends ExceptionHandler
{
    ...
    protected $dontReport = [
        InvalidQLDTAccount::class,
        InvalidAccountException::class,
        InvalidFormRequestException::class
    ];
    ...
    public function register ()
    {
        ...
        $this->renderable(function (InvalidQLDTAccount $exception)
        {
            return response('Invalid qldt account', 401);
        });
    }
    ...
    public function report (Throwable $e)
    {
        if ($e instanceof InvalidAccountException
            || $e instanceof InvalidQLDTAccount
